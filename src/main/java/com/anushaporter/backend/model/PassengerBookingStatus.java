...
public enum PassengerBookingStatus {
    ...
    private static final Map<PassengerBookingStatus, Set<PassengerBookingStatus>> VALID_TRANSITIONS = Map.ofEntries(
            ...
            Map.entry(DRIVER_ACCEPTED, EnumSet.of(DRIVER_ARRIVING, DRIVER_SEARCHING, CANCELLED_BY_CUSTOMER, CANCELLED_BY_DRIVER, CANCELLED_BY_ADMIN)),
            Map.entry(DRIVER_ARRIVING, EnumSet.of(DRIVER_ARRIVED, DRIVER_SEARCHING, CANCELLED_BY_CUSTOMER, CANCELLED_BY_DRIVER, CANCELLED_BY_ADMIN)),
            Map.entry(DRIVER_ARRIVED, EnumSet.of(TRIP_STARTED, DRIVER_SEARCHING, CANCELLED_BY_CUSTOMER, CANCELLED_BY_DRIVER, CANCELLED_BY_ADMIN)),
