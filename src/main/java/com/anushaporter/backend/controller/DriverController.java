...
public class DriverController {
    ...
    /**
     * PUT/POST/PATCH /api/drivers/{driverId}/wallet
     * Admin modifies driver wallet balance.
     * Supports:
     *  - "set": Sets absolute balance (e.g. 500.0)
     *  - "credit" / "add": Adds to balance
     *  - "debit" / "deduct": Subtracts from balance
     *  - "adjust": Applies signed amount
     */
    @RequestMapping(value = {"/{driverId}/wallet", "/wallet/{driverId}"}, method = {RequestMethod.PUT, RequestMethod.POST, RequestMethod.PATCH})
