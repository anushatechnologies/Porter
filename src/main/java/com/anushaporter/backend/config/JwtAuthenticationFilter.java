...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        // Skip filtering for auth endpoints, static resources, and admin panel
        // endpoints
        return path.startsWith("/api/auth/")
                ...
                || path.startsWith("/passenger-admin")
                || path.startsWith("/passenger-booking")
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (authHeader == null || !authHeader.startsWith("Bearer ")) {
            ...
            response.getWriter().write(
                    "{\"success\": false, \"error\": \"Unauthorized\", \"message\": \"Your session has expired. Please login again.\"}");
            return;
        }
